...
Java 平台模块系统是Jigsaw Project的一部分，把模块化开发实践引入到了 Java 平台中，可以让我们的代码可重用性更好！
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiadfoE97ycy7JJB6SHShK7TQ5nCcnvMbDPN3PPRNDbNoHz1qE5hkbckHA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiadNeRvod65tghBTtqk3XsbWBoIdzIpTviccnpmy9Tuic0MaUbTtZggJUQA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiadUhiar2vUnHDC43EHs146aSsL9icBf5GxknibYTLfpPhAcGlQCOtzIJqhQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
- **try-with-resources 增强** ：在 try-with-resources 语句中可以使用 effectively-final 变量（什么是 effectively-final 变量，见这篇文章：《Effectively Final Variables in Java》
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiadmRs2ibBGyMsNGmj7MQicA9ibLabLc6hj8ddqlSgGFh1KISaicAEBulq5Lw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiadfgwAFpKbQhrAZl1iclkAiaTEsyvKDLSADWmBxZvbOictEXD0HxxPgA6Aw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
JEP 330:启动单文件源代码程序（aunch Single-File Source-Code Programs） 可以让我们运行单一文件的 Java 源代码。此功能允许使用 Java 解释器直接执行 Java 源代码。源代码在内存中编译，然后由解释器执行，不需要在磁盘上生成 `.class` 文件了。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TxtxNGnwb2vnzMiaNyRoXMiaddpPV3l04Cg2Yr7iaxV1ZhocfGLIbkibpYvmpd29mAcE8DtjOtytph7qw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
